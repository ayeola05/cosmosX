...
export const experiences = [
  {
    id: 0,
    img: "https://www.cosmosxbtc.com/s/image/1.jpg",
    role: "CosmosX Glyphs",
    company: "Glyphs",
    // date: "June 2023 - Nov 2023",
    desc: "CosmosX Glyphs form the foundation of the CosmosX universe and were the first to be minted on Bitcoin ordinals. These 144 symbols resonate with profound meaning, each serving as a key to unlock deeper mysteries within the CosmosX realm. This inaugural collection invites viewers to explore the underlying cosmic themes that define the universe of CosmosX.",
    // skills: [
    //   "ReactJS",
    //   "Redux",
    //   "NodeJs",
  ...
  {
    id: 1,
    img: "https://www.cosmosxbtc.com/s/picture/s7.png",
    role: "CosmosX Stars",
    company: "Stars",
    // date: "Aug 2023 - Oct 2023",
    desc: "As the second collection of ordinals, CosmosX Stars captures the elegance and enigma of the universe. Each piece in this series showcases the splendor of celestial forms, expressing the vastness and beauty of space in an entirely new light. CosmosX Stars lays the foundation for understanding the cosmic landscape that Jiannan Huang has created.",
    // skills: [
    //   "Docker",
    //   "Terraform",
    //   "AWS",
  ...
  {
    id: 2,
    img: "https://www.cosmosxbtc.com/s/image/5.jpg",
    role: "CosmosX Wanderers",
    company: "Wanderers",
    // date: "June 2021 - Oct 2021",
    desc: "The CosmosX Wanderers are diverse beings from distant galaxies within the CosmosX universe. Ranging from energy entities to sophisticated cyborgs, these Wanderers are unified by a nomadic spirit and an innate urge to explore. Together, they channel cosmic energy, forming alliances to navigate unknown realms and preserve the balance of the CosmosX universe.",
    // skills: [
    //   "Android",
    //   "Java",
    //   "Kotlin",
...
export const education = [
  // {
  //   id: 0,
  //   img: "https://www.cosmosxbtc.com/s/image/6.jpg",
